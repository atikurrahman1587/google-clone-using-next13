...
export default function HomeSearch() {
  ...
  return (
    <>
        <form onSubmit={handelSubmit} className="flex w-full mt-5 mx-auto max-w-[90%] border border-gray-200 px-5 py-3 rounded-full hover:shadow-md focus-within:shadow-md transition-shadow sm:mx-w-xl lg:max-w-2xl">
        ...
        <div className="flex flex-col space-y-2 sm:space-y-0 sm:space-x-4 justify-center sm:flex-row mt-8">
            <button onClick={handelSubmit} className="btn">Google Search</button>
